...
contract ERC1155Recipient is ERC1155TokenReceiver {
    ...
    function onERC1155Received(address _operator, address _from, uint256 _id, uint256 _amount, bytes calldata _data)
        ...
        returns (bytes4)
    {
        console.log("onERC1155ReceivedHi");
        operator = _operator;
        from = _from;
        id = _id;
        amount = _amount;
...
contract ERC1155YulTest is DSTestPlus, ERC1155TokenReceiver {
    IERC1155 token;
    ...
    function testFailMintToWrongReturnDataERC155Recipient() public {
        token.mint(address(new WrongReturnDataERC1155Recipient()), 1337, 1, "");
    }
