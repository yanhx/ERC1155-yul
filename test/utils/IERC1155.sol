 ...
 * Adapted from OpenZeppelin to include custom functions.
 */
interface IERC1155 is IERC165 {
    ...
    function batchMint(address to, uint256[] calldata id, uint256[] calldata amounts, bytes calldata data) external;
